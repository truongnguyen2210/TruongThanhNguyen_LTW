...
body{
  background-image: url("http://localhost:8888/TruongThanhNguyen_LTW/backend/assets/img/bgdn.jpg");
  ...
  <div class="khoi-to">
    <div class="container  form-dn">
            <div class="row">
                ...
                <form action = "<?=$routing->base_url_backend('dologin.php')?>" method="post">
